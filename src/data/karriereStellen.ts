...
export const stellen: Stelle[] = [
  {
    ...
    kurzbeschreibung:
      'Teste digitale Anwendungen aus echter Nutzersicht und halte deine Eindrücke strukturiert fest. Aufgaben sind einfach gehalten — Vorkenntnisse nicht erforderlich.',
    beschreibung:
      'Du bist regelmäßig online unterwegs und achtest darauf, ob Webseiten oder Apps gut funktionieren? Dann könnte diese Tätigkeit gut zu dir passen. Zur Unterstützung suchen wir Personen, die digitale Anwendungen testen und ihre Eindrücke strukturiert festhalten. Die Aufgaben sind einfach gehalten und werden verständlich erklärt – Vorkenntnisse sind nicht erforderlich.',
    aufgaben: [
  ...
  },
  {
    ...
    beschreibung:
      'Als UX/UI Designer:in verantwortest du das visuelle und interaktive Erlebnis unserer Softwareprodukte. Du führst Nutzerforschung durch, erstellst Wireframes und High-Fidelity-Prototypen und arbeitest eng mit dem Entwicklungsteam zusammen.',
    aufgaben: [
  ...
  },
  {
    ...
    beschreibung:
      'Als DevOps Engineer sorgst du für eine robuste, skalierbare und sichere Infrastruktur. Du automatisierst Deployments, überwachst Systeme und arbeitest an der Weiterentwicklung unserer Cloud-Architektur.',
    aufgaben: [
